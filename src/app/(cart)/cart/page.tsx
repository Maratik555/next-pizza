...
import { WhiteBlock } from './../../../components/shared/write-block';
...
export default function CartPage() {
	const { totalAmount, items, loading, updateItemQuantity, removeCartItem, removeItemsAll } = useCart(true);
	...
	const onSubmit = async (data: TFormOrderData) => {
		...
		try {
			...
			console.log('Order created, redirecting to:', url);
			if (!url) {
